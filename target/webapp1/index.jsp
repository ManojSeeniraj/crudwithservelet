...
<body class="bg-image">
    ...
    <p><a href="adminLogin.jsp" style="padding-left: 1020px;"><button class="admin" type="submit">Admin</button></a></p>
    <br>
    <br>
    <br>
    <br>
    <form method="POST" action='/UserServelet?action=alredyexists' name="frmAddUser">
